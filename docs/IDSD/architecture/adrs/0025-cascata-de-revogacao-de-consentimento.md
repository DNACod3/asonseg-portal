...
- **Status:** Accepted (mecanismo) · semântica a definir pela DPO designada (diretora Angélica) + jurídico antes da USP-043 — owner confirmado
- **Data:** 2026-05-28 (atualizado 2026-05-29)
- **Decisores:** Arquiteto Bravi, Tech Lead · semântica: DPO diretora Angélica (D-001 resolvido) + jurídico (D-002 em andamento na Fase 0)
...
- USP-043 (e dependentes) **não vão a produção** até a semântica ser definida pela DPO e os termos aprovados (D-001 resolvido; resta a definição da semântica + gate D-002).
