...
/**
 * Placeholder honesto de `/privacidade` (USP-059 — AUTH-2). Página estática:
 * mata o link morto do cadastro (`RegisterPersonForm.tsx:225`) sem inventar
...
export const metadata: Metadata = {
  title: 'Política de Privacidade | ASONSEG',
  description: 'Política de privacidade do Portal ASONSEG.',
};

export default function PrivacidadePage() {
  return (
    <div className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 px-4 py-8 sm:px-6">
      <FormHeader title="Política de Privacidade" />
